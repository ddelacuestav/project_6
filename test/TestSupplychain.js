...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], 1, 'Error: Missing or Invalid item state')
    })    
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], 2, 'Error: Missing or Invalid item state')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferOne[2], distributorID, 'Error: Missing or Invalid Owner')
        assert.equal(resultBufferTwo[6], distributorID, 'Error: Missing or Invalid Owner')
        assert.equal(resultBufferTwo[4], productPrice, 'Error: Missing or Invalid Product Price')
        assert.equal(resultBufferTwo[5], 4, 'Error: Missing or Invalid item State')
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        assert.equal(resultBufferOne[2], distributorID, 'Error: Missing or Invalid Owner')
        assert.equal(resultBufferTwo[6], distributorID, 'Error: Missing or Invalid Owner')
        assert.equal(resultBufferTwo[5], 5, 'Error: Missing or Invalid item State')
    })
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferTwo[7], retailerID, 'Error: Missing or Invalid Owner')
        assert.equal(resultBufferOne[2], retailerID, 'Error: Missing or Invalid Owner')
    })    
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferOne[2], consumerID, 'Error: Missing or Invalid Owner')
        assert.equal(resultBufferTwo[8], consumerID, 'Error: Missing or Invalid Owner')
