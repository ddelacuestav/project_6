...
//  }
  ...
  function buyItem(uint _upc) onlyDistributor payable forSale(_upc) paidEnough(price) checkValue(_upc)
    // Call modifier to check if upc has passed previous supply chain stage
    ...
    // Transfer money to farmer
      ...
      address originFarmerIDPayable = items[_upc].originFarmerID;
